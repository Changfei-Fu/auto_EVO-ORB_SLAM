...
/*    
    ...
    if(mState!=NO_IMAGES_YET )
    {
        ...
        else if(fabs(mCurrentFrame.mTimeStamp-mLastFrame.mTimeStamp)>1.0)
        {
            cout << "mTimeStamp last: " << mLastFrame.mTimeStamp << "    mTimeStamp curr: " << mCurrentFrame.mTimeStamp << endl;
            if(mpAtlas->isInertial())
            {
